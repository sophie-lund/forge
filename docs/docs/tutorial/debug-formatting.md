...
See [`ExampleLanguage.cpp`](https://github.com/sophie-lund/forge/blob/main/test/ExampleLanguage.cpp) for an example of how to do this for a complete syntax tree.
