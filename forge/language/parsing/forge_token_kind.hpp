...
const TokenKind TOKEN_KW_DEFAULT     = TokenKind("'default'");
...
const TokenKind TOKEN_KW_FOR         = TokenKind("'for'");
...
const TokenKind TOKEN_KW_IN          = TokenKind("'in'");
...
const TokenKind TOKEN_KW_MATCH       = TokenKind("'match'");
const TokenKind TOKEN_KW_NAMESPACE   = TokenKind("'namespace'");
const TokenKind TOKEN_KW_NEVER       = TokenKind("'never'");
const TokenKind TOKEN_KW_NULL        = TokenKind("'null'");
...
const TokenKind TOKEN_LBRACKET       = TokenKind("[");
const TokenKind TOKEN_COLON          = TokenKind(":");
const TokenKind TOKEN_RBRACKET       = TokenKind("]");
