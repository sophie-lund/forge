...
TEST(integration_pure_math_bit_and, simple_u8) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_u16) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_u32) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_u64) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_usize) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_i8) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_i16) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_i32) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_i64) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_isize) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_bool) {
  runIntegrationTest(
...
TEST(integration_pure_math_bit_and, simple_f32) {
  runIntegrationTest(
