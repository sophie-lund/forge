...
TEST(integration_pure_math_gt, simple_u32_with_u32) {
  runIntegrationTest(
...
TEST(integration_pure_math_gt, simple_i32_with_i32) {
  runIntegrationTest(
...
TEST(integration_pure_math_gt, simple_f32_with_f32) {
  runIntegrationTest(
