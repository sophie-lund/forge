...
namespace forge {
BaseType::BaseType(lt::NodeKind kind, lt::SourceRange&& source_range)
...
void BaseType::on_format_debug(lt::DebugFormatter& formatter) const {
...
bool BaseType::on_compare(const lt::BaseNode& other) const {
  return is_const == static_cast<const BaseType&>(other).is_const &&
         on_compare_type(other);
}

std::shared_ptr<lt::BaseNode> BaseType::on_clone() const {
