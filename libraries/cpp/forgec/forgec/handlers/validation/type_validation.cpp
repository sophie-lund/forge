...
#include <forgec/type_logic/get_casting_mode.hpp>
...
lt::IHandler::Output TypeValidationHandler::on_leave_type_unary(
  ...
  if (input.node()->type_unary_kind == TypeUnaryKind::pointer) {
    ...
    LT_ABORT("unexpected unary type kind");
  }

  return Output();
}

lt::IHandler::Output TypeValidationHandler::on_leave_type_function(
...
lt::IHandler::Output TypeValidationHandler::on_leave_value_symbol(
...
lt::IHandler::Output TypeValidationHandler::on_leave_value_unary(
...
lt::IHandler::Output TypeValidationHandler::on_leave_value_binary(
...
lt::IHandler::Output TypeValidationHandler::on_leave_value_call(
...
lt::IHandler::Output TypeValidationHandler::on_leave_value_cast(
...
lt::IHandler::Output TypeValidationHandler::on_leave_statement_basic(
...
lt::IHandler::Output TypeValidationHandler::on_leave_statement_value(
...
lt::IHandler::Output TypeValidationHandler::on_leave_declaration_variable(
...
lt::IHandler::Output
TypeValidationHandler::on_leave_declaration_structured_type(
