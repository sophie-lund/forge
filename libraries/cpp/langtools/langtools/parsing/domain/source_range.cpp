...
SourceRange combine_source_ranges(const SourceRange& first,
  ...
  LT_ASSERT(first.start.offset.has_value(),
            "can only combine source ranges with all properties set");
  LT_ASSERT(first.end.has_value(),
            "can only combine source ranges with all properties set");
  LT_ASSERT(first.end.value().offset.has_value(),
            "can only combine source ranges with all properties set");
  LT_ASSERT(second.start.offset.has_value(),
            "can only combine source ranges with all properties set");
  LT_ASSERT(second.end.has_value(),
            "can only combine source ranges with all properties set");
  LT_ASSERT(second.end.value().offset.has_value(),
            "can only combine source ranges with all properties set");
