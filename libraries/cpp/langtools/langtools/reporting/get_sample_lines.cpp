...
GetSampleLinesResult get_sample_lines(
  ...
  LT_ASSERT(line_number_first > 0, "line numbers must be positive");
  LT_ASSERT(line_number_last > 0, "line numbers must be positive");
  LT_ASSERT(line_number_last >= line_number_first,
