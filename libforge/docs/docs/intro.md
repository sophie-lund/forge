...
Sycamore is a collection of C/C++ libraries for compiler development for use in other projects. See the [tutorial](./tutorial/defining-a-syntax-tree.md) section for how to get started using it.
