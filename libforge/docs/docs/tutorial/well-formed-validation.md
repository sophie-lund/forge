...
This is the first time we will be using handlers and passes in Sycamore.
...
There are a number of validation helper methods which are all defined in [`Validators.hpp`](https://github.com/sophie-lund/grove/blob/main/projects/sycamore/v1/include/sycamore-syntaxtree/Validators.hpp). You can use these to build up validation logic for all node types in your language.

## Full validator

See the full example in [`ExampleLanguage.cpp`](https://github.com/sophie-lund/grove/blob/main/projects/sycamore/v1/test/sycamore-syntaxtree/ExampleLanguage.cpp) in the [well formed validation handler](https://github.com/sophie-lund/grove/blob/500ba5f38016e436810528c84af5623e6c9ea6e5/projects/sycamore/v1/test/sycamore-syntaxtree/ExampleLanguage.cpp#L869) section.
